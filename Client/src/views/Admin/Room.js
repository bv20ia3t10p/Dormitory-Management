      ...
      <div class="section">
        ...
        <div class="row">
          <div class="col text-primary ml-2">
            <i class="fa fa-home fa-2x" aria-hidden="true"></i>Phòng còn trống
          </div>
          <div class="col  text-danger">
            <i class="fa fa-home fa-2x" aria-hidden="true"></i>Phòng đầy
          </div>
          <div class="col  text-success">
            <i class="fa fa-home fa-2x" aria-hidden="true"></i>Phòng đang chọn
          </div>
          {localStorage.getItem(localStorage.getItem("account")) == "Admin" ? (
            <div class="col">
              <input
                type="button"
