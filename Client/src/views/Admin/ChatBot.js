...
const ChatBot = () => {
  ...
  useEffect(() => {
    ...
    try {
      const idInLocal = localStorage.getItem("id");
      if (!idInLocal) throw new Error("Not logged in");
      setCurrentUser(() => ({
        id: idInLocal,
        name: "",
        token: "",
      ...
      >
        <div className="chatbox__header">
          ...
          <div className="chatbox__content--header">
            <h4 className="chatbox__heading--header">Hỗ trợ thông minh</h4>
            <p className="chatbox__description--header">
              Xin chào, tôi là trợ lý ảo tôi có thể giúp được gì cho bạn?
            </p>
          </div>
        </div>
