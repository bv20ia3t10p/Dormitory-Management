          ...
          <Form>
            <FormGroup>
              ...
              <div class="border-bottom border-danger">
                <i class="fa fa-university" aria-hidden="true"></i> {state.name}
              </div>
            </FormGroup>
            <FormGroup>
              <Label for="electricFee">Tiền điện</Label>
              <div class="border-bottom border-danger">
                <i class="fa fa-usd pr-1" aria-hidden="true"></i>
                {state.electricFee}
              </div>
            </FormGroup>
            <FormGroup>
              ...
              <div class="border-bottom border-danger">
                <i class="fa fa-tint" aria-hidden="true"></i> {state.waterFee}
              </div>
            </FormGroup>
            <FormGroup>
              <Label for="totalFee">
