          ...
          <Form>
            <FormGroup>
              ...
              <div class="border-bottom border-danger">
                <i class="fa fa-id-badge" aria-hidden="true"></i> {state.roomId}
              </div>
            </FormGroup>
            <FormGroup>
              <Label for="dateEnd">Ngày đăng ký</Label>
              <div class="border-bottom border-danger">
                <i class="fa fa-calendar" aria-hidden="true"></i>{" "}
                {moment(state.dateBegin).format("DD/MM/YYYY")} -{" "}
                {moment(state.dateEnd).format("DD/MM/YYYY")}
              </div>
            </FormGroup>
            <FormGroup>
              <Label for="numberOfMonth">Nội dung</Label>
              <div class="border-bottom border-danger">
                <i class="fa fa-bed" aria-hidden="true"></i> Phí lưu trú
              </div>
            </FormGroup>
            <FormGroup>
